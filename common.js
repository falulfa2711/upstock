    ...
    style.textContent = `
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
            .header-inner { padding: 0 12px; gap: 8px; height: 60px; }
            .logo-text { font-size: 18px; }
            .header-search { max-width: 180px; }
            .cart-btn span:not(.cart-count) { display: none; }
            .cart-float-btn { display: flex; position: fixed; bottom: 20px; right: 20px; background: var(--gradient); color: white; border: none; border-radius: 50px; padding: 12px 18px; font-size: 1em; font-weight: bold; z-index: 4500; box-shadow: 0 4px 15px rgba(124,58,237,0.5); cursor: pointer; align-items: center; gap: 6px; }
